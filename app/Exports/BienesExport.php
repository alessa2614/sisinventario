...
class BienesExport implements FromCollection, WithHeadings, WithStyles, WithCustomStartCell, WithColumnWidths, ShouldAutoSize
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells("A3:{$lastColumn}3")->setCellValue("A3", " REPORTE GENERAL DE BIENES ");
        ...
        $sheet->getStyle("A6:{$lastColumn}6")->applyFromArray([
            ...
            'fill' => ['fillType' => 'solid', 'color' => ['rgb' => '28A745']], // verde
