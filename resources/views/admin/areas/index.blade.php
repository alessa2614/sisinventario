        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title"> <b>Areas Registradas</b></h3>

                    <div class="card-tools">
                        <a class="btn btn-primary" href="{{ url('/admin/areas/create') }}">Crear nuevo</a>
                    </div>
                    <!-- /.card-tools -->
                </div>
                <!-- /.card-header -->
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <button type="button" class="btn btn-info" data-toggle="modal"
                                                    data-target="#ModalShow{{ $area->id }}">
                                                    <i class="fas fa-eye"></i>Ver
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="ModalShow{{ $area->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form action="{{ url('/admin/areas/' . $area->id) }}"
                                                            id="formulario{{ $area->id }}" method="POST"
                                                            class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger"
                                                                onclick="preguntar{{ $area->id }}(event)">
                                                                <i class="fas fa-trash-alt"></i> Eliminar
                                                            </button>
                                                        </form>
                                                        <script>
                                                            function preguntar{{ $area->id }}(event) {
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    if (result.isConfirmed) {
                                                                        ...
                                                                        document.getElementById("formulario{{ $area->id }}").submit();
                                                                    }
                                                                });
                                                            }
                                                        </script>
