...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 18pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Creacion  de Areas</li>
        </ol>
    </nav>
@stop
        ...
        <div class="col-md-12">
            <div class="card  card-primary">
                ...
                <div class="card-body" style="display: block;">
                    <form action="{{ url('/admin/areas/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <a href="{{ url('/admin/areas') }}" class="btn btn-danger">Cancelar</a>
