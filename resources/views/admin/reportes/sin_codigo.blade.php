...
@section('title', 'Reporte de Bienes Sin Código Patrimonial')

@section('content_header')
    <h1 class="text-center">📉 Reporte de Bienes Sin Código Patrimonial</h1>
@stop
        ...
        <div class="col-md-12">
            <div class="card  card-success">
                <div class="card-header">
                    <h3 class="card-title"><b>Bienes Sin Código Patrimonial</b></h3>
                </div>
                ...
                <div class="card-body table-responsive">
                    <div class="reporte-encabezado text-center mb-4">
                        ...
                        <h3><b>📉 REPORTE DE BIENES SIN CODIGO PATRIMONIAL</b></h3>
                        ...
                        <tbody>
                            @forelse ($bienes as $bien)
                                <tr>
                                    ...
                                    <td>{{ $bien->estado?->nombre ?? 'Sin estado' }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="16" class="text-center text-muted">No hay bienes sin codigo Patrimonial</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    $("#example1").DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function() {
                    window.location.href = "{{ route('reportes.sin_codigo.excel') }}";
                }
            },
            {
                ...
                action: function() {
                    window.location.href = "{{ route('reportes.sin_codigo_pdf') }}";
                }
            },
            {
