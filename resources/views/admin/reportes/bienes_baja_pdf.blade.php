...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Bienes Dados de Baja</title>
    <style>
        body {
            font-family: DejaVu Sans, sans-serif;
            font-size: 11px; /* 👈 más pequeño para que entre */
        }
        .header {
            text-align: center;
            margin-bottom: 10px;
        ...
        th, td {
            ...
            padding: 2px;
            text-align: center;
            font-size: 6px; /* 👈 tabla más compacta */
...
<body>
    ...
    <div class="header">
        ...
        <p><i>Generado el {{ \Carbon\Carbon::now()->format('d/m/Y H:i') }}</i></p>
    </div>
