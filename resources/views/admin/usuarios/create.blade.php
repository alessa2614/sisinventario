...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 18pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Reguistro de un nuevo usuario</li>
        </ol>
    </nav>
@stop
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('nombres') }}" class="form-control"
                                                id="nombres" name="nombres" placeholder="Ingrese el nombre" required>
                                        </div>
                                        @error('nombres')
                                            <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('apellidos') }}" class="form-control"
                                                id="apellidos" name="apellidos" placeholder="Ingrese el nombre" required>
                                        </div>
                                        @error('apellidos')
                                            <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('email') }}" class="form-control"
                                                id="email" name="email" placeholder="Ingrese el nombre" required>
                                        </div>
                                        @error('email')
                                            <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="tipo_documento" class="form-control" id="tipo_documento">
                                                ...
                                                <option value="Ruc"
                                                    {{ old('tipo_documento') == 'RUC' ? 'selected' : '' }}>Ruc</option>
                                                <option value="CI"
                                                    {{ old('tipo_documento') == 'CI' ? 'selected' : '' }}>CI</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('celular') }}" class="form-control"
                                                id="celular" name="celular" placeholder="Ingrese el nombre" required>
                                        </div>
                                        @error('celular')
                                            <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" value="{{ old('direccion') }}" class="form-control"
                                                id="direccion" name="direccion" placeholder="Ingrese el nombre" required>
                                        </div>
                                        @error('direccion')
                                            <small style="color: red">{{ $message }}</small>
                                        @enderror
