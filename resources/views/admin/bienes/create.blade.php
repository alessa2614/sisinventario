...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 18pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Creacion de Bienes</li>
        </ol>
    </nav>
@stop
        ...
        <div class="col-md-12">
            <div class="card  card-primary">
                ...
                <div class="card-body" style="display: block;">
                    <form action="{{ url('/admin/bienes/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="card card-body bg-white shadow-sm" style="border: 1px solid #b3b4b5;" name="descripcion"
                                                    id="descripcion" cols="100" rows="1" placeholder="Ingrese una descripcion" required></textarea>
                                            </div>
                                            @error('descripcion')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ old('marca') }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ old('modelo') }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ old('numero_doc') }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ old('tipo_documento') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="{{ old('medidas') }}" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" value="{{ old('fecha_adquisicion') }}"
                                                    class="form-control" id="fecha_adquisicion" name="fecha_adquisicion"
                                                    placeholder="Ingrese las fecha_adquisicion" required>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="valor_inicial">Precio de adquisicion:</label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i
                                                ...
                                                <input type="number" step="0.01" min="0"
                                                    value="{{ old('valor_inicial') }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0"
                                                    value="{{ old('depreciacion') }}" class="form-control"
                                                    id="depreciacion" name="depreciacion"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="estado_id" id="" class="form-control" required>
                                                    <option value="">Seleccionar una estado ...</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="director_id" id="" class="form-control" required>
                                                    <option value="">Seleccionar un director ...</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="{{ url('/admin/bienes') }}" class="btn btn-danger">Cancelar</a>
